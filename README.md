...
If sufficient information is unavailable, the model should refuse to answer from unsupported information. 5. Evaluation
...
This project was built to explore how a production-oriented Retrieval-Augmented Generation (RAG) system designed to demonstrate a complete document ingestion, retrieval, reranking, generation, and evaluation pipeline.
